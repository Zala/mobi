...
/**
 * Servlet implementation class GetDijkstraRouteServlet
 */

public class GetDijkstraRouteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetDijkstraRouteServlet() {
        super();
					...
					if (country != null && !country.equals("")) {
						...
						for (int i = 0; i < lats.size() - 1; i++) {
							...
							if (transport.equals(StringConstants.CAR_DISPLAY_TYPE)) {
								...
								segment = mobisGraph.dijkstraPath(dbUtils, con, fromCoord, i, transport, time, toCoord, criteria, 0.00001, "ways", true, false, "4326", i == 0 ? true : false, "") ;
